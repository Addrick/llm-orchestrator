...
import src.webui.modules.shared as shared
from src.chat_system import ChatSystem
from src.webui.modules import models
from src.webui.modules.cache_utils import process_llamacpp_cache
from src.webui.modules.callbacks import (
    Iteratorize,
    Stream,
    _StopEverythingStoppingCriteria
)
from src.webui.modules.extensions import apply_extensions
from src.webui.modules.grammar.grammar_utils import initialize_grammar
from src.webui.modules.grammar.logits_process import GrammarConstrainedLogitsProcessor
from src.webui.modules.html_generator import generate_basic_html
from src.webui.modules.logging_colors import logger
from src.webui.modules.models import clear_torch_cache, load_model
...
async def _generate_reply(message, state, stopping_strings=None, is_chat=False, escape_html=False, for_ui=False, bot=None):

    # TODO: this is where to call my on_message function
    # need to get a ChatSystem in here somehow
    # original behavior utilizes a generator with 'yield'
    ...
    yield dev_response
    persona_name = dev_response
    response = await bot.generate_response(persona_name, message.content, context=[], image_url=None)
    yield response
...
def generate_reply_wrapper(question, state, stopping_strings=None, bot=None):
    """
    ...
    for reply in generate_reply(question, state, stopping_strings, is_chat=False, escape_html=True, for_ui=True, bot=bot):
