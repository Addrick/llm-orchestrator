...
from src.webui.modules import sampler_hijack
from src.webui.modules.logging_colors import logger
from src.webui.modules.models_settings import get_model_metadata
...
if shared.args.deepspeed:
    ...
    from src.webui.modules.deepspeed_parameters import generate_ds_config
...
def llamacpp_loader(model_name):
    from src.webui.modules.llamacpp_model import LlamaCppModel
...
def llamacpp_HF_loader(model_name):
    from src.webui.modules.llamacpp_hf import LlamacppHF
...
def ExLlamav2_loader(model_name):
    from src.webui.modules.exllamav2 import Exllamav2Model
...
def ExLlamav2_HF_loader(model_name):
    from src.webui.modules.exllamav2_hf import Exllamav2HF
...
def AutoGPTQ_loader(model_name):
    try:
        import src.webui.modules.AutoGPTQ_loader
    ...
    return src.webui.modules.AutoGPTQ_loader.load_quantized(model_name)
...
def TensorRT_LLM_loader(model_name):
    try:
        from src.webui.modules.tensorrt_llm import TensorRTLLMModel
    except ModuleNotFoundError:
